...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{URL::asset('js/plugins/fontawesome-free/css/all.min.css')}}">
    <!-- Ionicons -->
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    <!-- Toast -->
    <link rel="stylesheet" href="{{URL::asset('js/plugins/toastr/toastr.min.css')}}">
    <!-- datatable -->
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <img src="{{URL::asset('img/user1-128x128.jpg')}}" class="user-image img-circle elevation-2" alt="User Image">
        <span class="d-none d-md-inline">{{ Str::upper(Auth::user()->name) }}</span>
        </a>
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <!-- User image -->
          <li class="user-header bg-primary">
            <img src="{{URL::asset('img/user1-128x128.jpg')}}" class="img-circle elevation-2" alt="User Image">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{URL::asset('img/AdminLTELogo.png')}}"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">PORTALBERITA</span>
    </a>
